...
// Discover: Tamil originals currently on OTT in India — newest first
...
function MovieCard({ item, genreMap, onClick, idx }) {
  ...
  return (
    ...
    >
      {/* Poster — fixed height keeps all cards uniform */}
      <div style={{
          ...
          <div style={{textAlign:"center",padding:"80px 20px"}}>
            {filters.platform !== "All" && !platformsReady ? (
              <>
                ...
                <p style={{color:C.border,fontSize:"11px",marginTop:"8px"}}>Takes 10–15 seconds on first load</p>
              </>
            ) : (
              <>
